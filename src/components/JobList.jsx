...
import { BriefcaseIcon, MapPinIcon, ClockIcon, ExternalLinkIcon, TrendingUpIcon } from 'lucide-react'
...
export default function JobList() {
  const { jobs, jobsLoading, selectedJob, setSelectedJob, tailorResume, searchQuery } = useApp()
